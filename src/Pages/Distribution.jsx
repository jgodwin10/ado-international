...
const Distribution = () => {
  return (
    <>
      <div className="bg-[url('./Images/Contact.png')] bg-cover bg-bottom before:contents-[''] before:absolute before:h-full before:w-full before:top-0 before:left-0 before:bg-[#00000099] relative h-[30vh] 2xl:h-[284px] w-full">
        <div className=" absolute md:px-[50px] px-6 top-0 left-0 w-full h-full">
          <div className="flex items-center h-full max-w-[1600px] mx-auto">
            <p className="2xl:text-[70px] text-[3.4vw] font-bold text-white">
              Distribution
            </p>
          </div>
        </div>
      ...
      <div className="bg-[url('./Images/dist.jpeg')] bg-cover">
        <div className="max-w-[1600px] py-20  mx-auto md:px-[50px] px-6">
          <div className="text-center space-y-4">
            <h2 className="text-black text-[1.8vw] 2xl:text-[45px] font-medium">
              Discover our Distribution Process
            </h2>
            <p className="text-[#1E1E1E] text-[1.1vw] 2xl:text-[18px]">
          ...
          <div className="grid grid-cols-3 gap-[40px] pt-20 pb-3">
            <div className="text-center space-y-[27px]">
              ...
              <h2 className="2xl:text-[24px] text-[1.5vw] text-black font-medium">
                Preparation and Packaging
              </h2>
              <p className="2xl:text-[18px] text-[1.1vw] text-black font-medium">
