...
const Cart = () => {
  ...
  return (
    <div className="">
      <div className="bg-[#fef9f3] md:px-[50px] px-6 w-full ">
        <div className="max-w-[1600px] py-10 gap-8 flex items-center justify-between mx-auto ">
          <div className="flex-1 h-[266px] py-5 pb-6 bg-white cart ">
            ...
            <div className="flex justify-between items-center px-6">
              <div className="flex items-center gap-x-8">
                ...
                />
                <div>
                  <p className="text-[22px] text-[#787878] font-semibold">
              ...
              <p className="text-[28px] font-semibold">₦18,000</p>
            </div>
            <div className="flex justify-between items-center px-6 ">
              <div className="flex items-center gap-3 text-[#E78707] font-semibold">
                <img src={Img1} alt="" />
                <p className="text-[22px] uppercase">Remove</p>
              </div>
