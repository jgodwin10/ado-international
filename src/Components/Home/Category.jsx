      ...
      <div className="max-w-[1600px] mx-auto">
        <div className="flex justify-between items-center">
          <div className="max-w-[700px] space-y-4">
            ...
            <p className="text-[#0D0D0D] text-[22px]">
        ...
        <div className="grid grid-cols-4 relative gap-8 pt-16">
          {Items.map((item, index) => {
            return (
              <div
                key={index}
                className="bg-white category hover:scale-[1.1] overflow-hidden cursor-pointer duration-500 w-full rounded-[15px]"
              >
