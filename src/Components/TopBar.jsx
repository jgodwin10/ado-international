...
const TopBar = () => {
  return (
    <div className=" shadow fixed md:px-10 min-[1200px]:px-[145px] min-[1020px]:px-[60px] hidden px-6 -top-1 bg-white left-0 w-full z-[99999999] lg:flex justify-between items-center ">
